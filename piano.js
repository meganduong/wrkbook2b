// this script is attributed to mrbombmusic from https://editor.p5js.org/mrbombmusic/sketches/ryeLfZTd-
//minor alterations with the assistance of chat gpt
let typedKeys = "";
var space = 90;
var rSide = [];
var black = [];
...
var blKee = ['W', 'E', null, 'T', 'Y', 'U', null, 'O', 'I', null, null];
var midKee = [null, 'S', null, null, 'X', 'H', null, null, 'L', null];
...
//alteration
    ...
    if (typedKeys.length > 8) {
      typedKeys = typedKeys.slice(-8);
    }
  
    if (typedKeys === "weeksix") {
      window.location.href = "week-6.html";
    }
